...
<head>
  ...
  <!-- bootstrap core css -->
  <link rel="stylesheet" type="text/css" href="public/oxer-html/css/bootstrap.css" />

  <!-- fonts style -->
  <link href="https://fonts.googleapis.com/css?family=Baloo+Chettan|Dosis:400,600,700|Poppins:400,600,700&display=swap" rel="stylesheet" />
  <!-- Custom styles for this template -->
  <link href="public/oxer-html/css/style.css" rel="stylesheet" />
  <!-- responsive style -->
  <link href="public/oxer-html/css/responsive.css" rel="stylesheet" />
</head>
...
<body>
      ...
      <div class="container">
        <div class="header_nav">
          <a class="navbar-brand brand_desktop" href="index.html">
            <img src="public/oxer-html/images/logo.png" alt="" />
          </a>
          <div class="main_nav">
            <div class="top_nav">
              <ul class=" ">
                <li class="">
                  <a class="" href="">
                    <img src="public/oxer-html/images/telephone.png" alt="" />
                    <span> +01 1234567890</span>
                  </a>
                </li>
                <li class="">
                  <a class="" href="">
                    <img src="public/oxer-html/images/mail.png" alt="" />
                    <span>demo@gmail.com</span>
                  </a>
                </li>
                <li class="">
                  <a class="" href="">
                    <img src="public/oxer-html/images/location.png" alt="" />
            ...
            <div class="class_box-container">
              <div class="owl-carousel owl_carousel1">
                <div class="item">
                  <div class="box">
                    <div class="img-box">
                      ...
                      <div class="detail-box">
                        <button>
                          <img src="public/oxer-html/images/play-icon.png" alt="">
                        </button>
                        <h2>
                          Boxing
                        </h2>
                ...
                <div class="item">
                  <div class="box">
                    <div class="img-box">
                      <img src="public/oxer-html/images/c1.jpg" alt="">
                      <div class="detail-box">
                        <button>
                          <img src="public/oxer-html/images/play-icon.png" alt="">
                        </button>
                ...
                <div class="item">
                  <div class="box">
                    <div class="img-box">
                      <img src="public/oxer-html/images/c2.jpg" alt="">
                      <div class="detail-box">
                        <button>
                          <img src="public/oxer-html/images/play-icon.png" alt="">
                        </button>
    ...
    <div class="container-fluid">
      ...
      <div class="row">
        <div class="col-md-6 pl-0">
          <div class="box b1">
            <div class="img-box">
              <img src="public/oxer-html/images/b1.jpg" alt="">
            </div>
            <div class="row">
        ...
        <div class="col-md-6 pr-0">
          <div class="box b2">
            <div class="img-box">
              <img src="public/oxer-html/images/b2.jpg" alt="">
            </div>
            <div class="row">
              ...
              <div class="carousel-wrap ">
                <div class="owl-carousel">
                  <div class="item">
                    <div class="box">
                      <div class="img-box">
                        <img src="public/oxer-html/images/client1.png" alt="" />
                      </div>
                      <div class="detail-box">
                        <h4>
                          Jone Moe
                        ...
                        <img src="public/oxer-html/images/quote.png" alt="" />
                      </div>
                    </div>
                  </div>
                  <div class="item">
                    <div class="box">
                      <div class="img-box">
                        <img src="public/oxer-html/images/client2.png" alt="" />
                      </div>
                      <div class="detail-box">
                        <h4>
                          Lio Uji
            ...
            <div class="col-md-6 pr-0">
              ...
              <section class=" footer_section ">
                <div class="social_box">
                  <a href="#">
                    <img src="public/oxer-html/images/facebook.png" alt="">
                  </a>
                  <a href="#">
                    <img src="public/oxer-html/images/twitter.png" alt="">
                  </a>
                  <a href="#">
                    <img src="public/oxer-html/images/linkedin.png" alt="">
                  </a>
                  <a href="#">
                    <img src="public/oxer-html/images/instagram.png" alt="">
                  </a>
                  <a href="#">
                    <img src="public/oxer-html/images/youtube.png" alt="">
                  </a>
                </div>
                <p>
  ...
  <script type="text/javascript" src="public/oxer-html/js/jquery-3.4.1.min.js"></script>
  <script type="text/javascript" src="public/oxer-html/js/bootstrap.js"></script>
